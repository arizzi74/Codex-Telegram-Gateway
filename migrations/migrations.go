...
var Files = []string{"001_registry.sql", "002_admin_session_activity.sql", "003_telegram_session_wizards.sql", "004_telegram_session_modes.sql", "005_telegram_selection_delivery.sql", "006_telegram_reply_delivery.sql", "007_worker_updates.sql", "008_telegram_answer_progress.sql", "009_gateway_polling_indexes.sql"}
