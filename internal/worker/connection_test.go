...
func TestConnectionAdvertisesCapabilitiesThroughoutConnection(t *testing.T) {
	...
	server := newWorkerTLSServer(t, http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		if err != nil || helloEnvelope.Type != "hello" || !hello.SupportsWebUI || !hello.SupportsImageInput || !hello.SupportsSessionWorkspaces || !hello.SupportsSessionDeletion || !hello.SupportsConversationHistory {
		...
		if err != nil || heartbeatEnvelope.Type != "heartbeat" || !heartbeat.SupportsWebUI || !heartbeat.SupportsImageInput || !heartbeat.SupportsSessionWorkspaces || !heartbeat.SupportsSessionDeletion || !heartbeat.SupportsConversationHistory {
