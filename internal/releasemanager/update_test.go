...
func TestWorkerPrepareReportsKnownDeferralReasons(t *testing.T) {
	for _, test := range []struct {
		...
		{"native-protocol-reason", "worker update: native CLI activity could not be verified: private-token-value", "worker update deferred: native CLI activity could not be verified; see worker service log for the protocol reason"},
		{"native-observation-gap", "worker update: native CLI activity needs fresh verification: private-token-value", "worker update deferred: native CLI activity needs fresh verification"},
		{"native-observation-race", "worker update: native CLI activity changed during idle verification; retry when settled", "worker update deferred: native CLI activity changed during idle verification; retrying at the next check"},
		...
		{"runtime-rpc-closed", "worker update: runtime RPC transport is closed", "worker update deferred: runtime RPC transport is closed"},
		{"runtime-rpc-initializing", "worker update: runtime RPC client is not initialized", "worker update deferred: runtime RPC client is still initializing"},
		{"runtime-rpc-overflow", "worker update: runtime RPC tracking capacity was exceeded", "worker update deferred: runtime RPC tracking capacity was exceeded; inspect worker status before a controlled restart"},
		{"runtime-rpc-unconfirmed", "worker update: runtime has unconfirmed mutating requests", "worker update deferred: runtime has unconfirmed mutating requests; inspect worker status before a controlled restart"},
		{"runtime-rpc-approval", "worker update: runtime approvals or input are pending", "worker update deferred: runtime approvals or input are pending"},
		{"runtime-rpc-pending", "worker update: runtime RPC requests are still in flight", "worker update deferred: runtime RPC requests are still in flight"},
